import { useParams,Link } from "react-router-dom" //Nos permite leer los paametros de la URL en Reac
  ...
  return (
    <>
        ...
        <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white' >
            ...
            {!cargando && <Alerta //Cuando ya no este cargando entonces ya muestra la alerta
              alerta={alerta}
            />}
